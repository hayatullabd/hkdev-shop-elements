...
(function ($) {
	...
	function apply($cat, options) {
		...
		var data = $.extend({}, params, {
			...
			show_buy_now: $cat.attr('data-show-buy-now') || 'yes',
			buy_now_text: $cat.attr('data-buy-now-text') || '',
			buy_now_icon: $cat.attr('data-buy-now-icon') || 'yes',
			buy_now_action: $cat.attr('data-buy-now-action') || 'checkout',
			buy_now_after: $cat.attr('data-buy-now-after') || 'auto',
			image_size: $cat.attr('data-image_size') || 'woocommerce_thumbnail',
			image_size_mode: $cat.attr('data-image_size_mode') || 'preset',
			custom_img_w: $cat.attr('data-custom_img_w') || 0,
			custom_img_h: $cat.attr('data-custom_img_h') || 0,
			custom_img_w_tablet: $cat.attr('data-custom_img_w_tablet') || 0,
			custom_img_h_tablet: $cat.attr('data-custom_img_h_tablet') || 0,
			custom_img_w_mobile: $cat.attr('data-custom_img_w_mobile') || 0,
			custom_img_h_mobile: $cat.attr('data-custom_img_h_mobile') || 0,
			custom_img_fit: $cat.attr('data-custom_img_fit') || 'cover',
			custom_img_pos_x: $cat.attr('data-custom_img_pos_x') || 50,
			custom_img_pos_y: $cat.attr('data-custom_img_pos_y') || 50,
			hk_hidden: $cat.attr('data-hide-hidden'),

 ...
 * hkdev-shop theme) which ContactFormEngine reads when rendering the form.
 *
 ...
 */
final class ContactFormOptions {

	/**
	 * Parent admin menu slug (registered by CheckoutOptions).
	 *
	 * @var string
	 */
